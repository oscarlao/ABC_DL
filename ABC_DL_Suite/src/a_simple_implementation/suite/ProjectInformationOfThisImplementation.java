...
public class ProjectInformationOfThisImplementation {
    ...
    public static ProjectInformation getProjectInformation() throws Exception            
    {
        ...
        return new ProjectInformation("observed_fake_data", new ModelsToRunABC_DL(""), "C:\\Users\\olao\\OneDrive - CRG - Centre de Regulacio Genomica\\ABC_DL\\test_model\\","fsc26",4, new WINDOWS(), 10000, training, replication, pops_to_retrieve);
    }    
}
